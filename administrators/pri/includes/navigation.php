...
<div class="collapse navbar-collapse" id="navbar-ex1-collapse">
    <ul id="ulPrincipal" class="nav navbar-nav">
        ...
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-users fa-1x"></i> Usuarios <span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li><a href="allUsers.php"><i class="fa fa-users fa-1x"></i> Todos los usuarios</a></li>
                <li><a href="allUsersGeolocation.php"><i class="fa fa-map-marker fa-1x"></i> Ubicación de usuarios</a></li>
            </ul>
        </li>                                                                     
    </ul>      
</div><!-- /.navbar-collapse -->