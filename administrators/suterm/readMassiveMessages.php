...
<html lang="es">
    <head>
        ...
        <title>Mensajes masivos leídos</title>
    ...
    <body> 
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                if($('#ajaxMask:visible')){
                    $.post('webServices/getReadMassiveMessages.php', {param1: 'value1'}, function(data, textStatus, xhr) {
                ...
                $('#addQuery').on('click', '.btnWhoRead', function(event) {console.log('mostrar usuarios');
                    ...
                    $('#addWhoRead').DataTable({
                        "ajax": "webServices/getWhoReadMassiveMessages.php?messageId="+messageId,
                        "columns": [
                            {"data": "user_id"},
                            {"data": "user_name"},
                            {"data": "cuando"}
                ...
                $('#addQuery').on('click', '.btnWhoUnread', function(event) {console.log('mostrar usuarios');
                    ...
                    $('#addWhoUnread').DataTable({
                        "ajax": "webServices/getWhoUnreadMassiveMessages.php?messageId="+messageId,
                        "columns": [
                            {"data": "user_id"},
                            {"data": "user_name"},
